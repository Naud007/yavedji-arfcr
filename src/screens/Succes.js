...
const Succes = () => {
    ...
    return (
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: GlobalColors.primary }} >
            ...
            <TouchableOpacity onPress={() => dispatch({type: "SET_LOGIN", value: true})} style={{ backgroundColor: GlobalColors.light, position: 'absolute', bottom: "12.5%", paddingVertical: 15, paddingHorizontal: 24, borderRadius: 50 }}>
